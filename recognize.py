...
classifier = cv2.CascadeClassifier(r"C:\Users\debas\OneDrive\Desktop\Face Detection\Face_Detectiondev\haarcascade_frontalface_default.xml")

model = load_model(r"C:\Users\debas\OneDrive\Desktop\Face Detection\Face_Detectiondev\final_model.h5")

URL = 'http://192.0.0.4:8080/shot.jpg'

def get_pred_label(pred):
    labels = ["DEBASIS","JD","Shivam"]
    return labels[pred]
